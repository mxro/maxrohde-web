    ...
    <>
      ...
      <div className="container px-8 py-5 lg:py-8 mx-auto xl:px-5 max-w-screen-lg">
        ...
        <div className="text-center">
          <p className="text-lg">Code and Contemplations</p>
        </div>
        <div className="mx-auto prose text-center dark:prose-invert mt-14">
          ...
          <p>
            Please reach out with comments, questions, suggestions and queries.
            You can contact me on ([me]@gmail.com, me: “maxrohde.public”) and on
            social networks.
          </p>
