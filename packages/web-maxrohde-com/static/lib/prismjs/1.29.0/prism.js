/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+bash+coffeescript+docker+go+go-module+graphql+hcl+java+markdown+plant-uml+jsx+tsx+sql+typescript+typoscript+yaml */
var _self =
